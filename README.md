...
Landing page → https://audit.lailarallc.com · Data Debt Calculator → https://calculator.lailarallc.com
...
Try it live → https://velocity.lailarallc.com
...
Try it live → https://deductions.lailarallc.com
...
Try it live → https://shortships.lailarallc.com
...
Acquisition due diligence portfolio piece. UCI Online Retail Dataset reframed as commercial DD — segment economics, customer-base trajectory, concentration risk, LTV modeling, and post-close action planning. Built in R + Quarto, deployed on Cloudflare Pages. Live report → https://dd.lailarallc.com
...
Python · SQL · R · React · Dash · Shiny · Quarto · Excel · PostgreSQL · dbt · Dagster · SQLite · Plotly · pandas · FastAPI · Fly.io · Cloudflare Pages · VS Code · Claude Code
